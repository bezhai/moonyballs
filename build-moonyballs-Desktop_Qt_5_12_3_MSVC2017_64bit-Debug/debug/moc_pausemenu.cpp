...
QT_MOC_LITERAL(1, 10, 6), // "resume"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 9), // "closegame"
QT_MOC_LITERAL(4, 28, 15), // "on_Exit_clicked"
QT_MOC_LITERAL(5, 44, 15) // "on_Back_clicked"

    },
    "PauseMenu\0resume\0\0closegame\0on_Exit_clicked\0"
    "on_Back_clicked"
};
...
void PauseMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseMenu::resume)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PauseMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseMenu::closegame)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PauseMenu::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_PauseMenu.data,
    qt_meta_data_PauseMenu,
    qt_static_metacall,
    nullptr,
    nullptr
} };
